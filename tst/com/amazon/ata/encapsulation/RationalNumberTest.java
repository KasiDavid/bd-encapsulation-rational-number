...
public class RationalNumberTest {
    ...
    public void constructor_existingRationalNumber_createsCopy() {
        //GIVEN
        RationalNumber original = new RationalNumber(3, 6);

        //WHEN
        RationalNumber fromExisting = new RationalNumber(original);

        //THEN
        assertEquals(fromExisting.getNumerator(), original.getNumerator());
        assertEquals(fromExisting.getDenominator(), original.getDenominator());
    }
